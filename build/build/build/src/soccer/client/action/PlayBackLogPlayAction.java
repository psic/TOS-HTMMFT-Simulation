...
public class PlayBackLogPlayAction extends AbstractClientAction {
	...
	private static final long serialVersionUID = 7894632791835396700L;

	public PlayBackLogPlayAction() {
		super();
		putValue(NAME, "Play Back the log file");
		URL imgURL = ViewerClientMain.class.getResource("/imag/vback.gif");
	...
	public void actionPerformed(ActionEvent e) {
		if (getSoccerMaster().getReplayer() != null)
			getSoccerMaster().getReplayer().setStatus(Replayer.BACK);
