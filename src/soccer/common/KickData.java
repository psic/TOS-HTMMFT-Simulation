...
public class KickData implements Data
{
  ...
  /**
   * the anticipated interception point
   */
  public Vector2d endPoint = new Vector2d();
  
  /**
   * the anticipated ID of ball pass receiver 
   */
  public int receiverID = -1;
  
  /**
   * side of the anticipated ball pass receiver 
   */
  public char side = '?';
 ...
 /**
  ...
  public void readData(StringTokenizer st)
  {
    ...
    // Get x
    double x = ( Integer.parseInt(st.nextToken()) )/100.0;    

    // Get the " "
    st.nextToken();          

    // Get y
    double y = ( Integer.parseInt(st.nextToken()) )/100.0;  
    ...
    // Get receiverID
    receiverID = Integer.parseInt(st.nextToken());    
  ...
  public void writeData(StringBuffer sb) 
  {
    ...
    sb.append((int)force);
    sb.append(' ');
    sb.append( (int)(endPoint.getX()*100) );
    sb.append(' ');
    sb.append( (int)(endPoint.getY()*100) );
    sb.append(' ');
    sb.append((int)receiverID);
    sb.append(' ');
    sb.append(side);
  } 
}
