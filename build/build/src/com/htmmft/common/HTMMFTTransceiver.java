...
public class HTMMFTTransceiver {
   ...
   */
  public HTMMFTTransceiver(boolean isServer) {
    try {
		if(!isServer) {
   ...
   */
  public HTMMFTTransceiver(int port) {
    try {
