...
/**
 * This class is an empty packet, used by a viewer client to remind the sever that
...
public class EmptyData implements Data {
	...
	/**
	 * Constructs a EmptyData for reading and writing from an UDP packet.
	 */
	public EmptyData() {
	} 
