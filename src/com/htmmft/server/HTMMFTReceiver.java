...
//<=========
	...
	private void connectToPlayerClient( ConnectData aConnectData, 
		...
		playerId =  aConnectData.playerID;
		//System.out.println("Server is connecting to player " + playerId + "-" + side + " / " + role);
		...
		//System.out.println("Server is connecting  2 to player " + playerId + "-" + side);
		...
		//	System.out.println("Server is connecting  3 to player " + playerId + "-" + side);
			soccerWorld.addPlayer(player);
		//	System.out.println("Server is connecting  4 to player " + playerId + "-" + side);
