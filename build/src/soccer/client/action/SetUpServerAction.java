...
public class SetUpServerAction extends AbstractClientAction {
	...
	private static final long serialVersionUID = 7465190058370929587L;

	public SetUpServerAction() {
		super();
		putValue(NAME, "Start Local Server...");
		URL imgURL = ViewerClientMain.class.getResource("/imag/field.gif");
	...
	public void actionPerformed(ActionEvent e) {
        int confirm = JOptionPane.showOptionDialog(getSoccerMaster(), 
                "This will start the soccer server application on local computer.\n"
        		+ "This is only allowed if this Viewer Client is Game Cordinator.\n"
                		+ "Continue?", 
                "Starting Soccer Server", JOptionPane.YES_NO_OPTION, 
