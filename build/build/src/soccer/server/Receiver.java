...
public class Receiver {
	 ...
	 */
	public Receiver(SoccerServerWorld soccerWorld, 
	...
	public synchronized Packet runOneStep() {
		Packet packet = null;
		try {
			packet = SoccerServerMain.transceiver.receive();
			processPacket(packet);

		} catch (Exception e) {
			System.out.println("Fatal error in Receiver. Server program terminated.");
			e.printStackTrace();
			System.exit(1);
		}
		return packet;
