...
public class ExitAction extends AbstractClientAction {
	...
	private static final long serialVersionUID = 8469508951884976209L;
	
	public ExitAction() {
		super();
		putValue(NAME, "Exit");
		URL imgURL = ViewerClientMain.class.getResource("/imag/exit.gif");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (option == JOptionPane.YES_OPTION) {
			getSoccerMaster().quit(ByeData.DISCONNECT);	// TODO
		}
