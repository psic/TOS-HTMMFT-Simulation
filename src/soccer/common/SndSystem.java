...
//	private Hashtable<String, AudioClip> clips;
//	private ArrayList<AudioClip> music;
//	private boolean musicOn;
//	private boolean soundOn;
//	private AudioClip currentMusic;
//
//	public SndSystem() {
//		clips = new Hashtable<String, AudioClip>();
...
//			try {				
//				clipURL =
//					ViewerClientMain.class.getResource("/sound/" + id + ".wav");
//			} catch (Exception e ) {
//				clipURL =
//					ViewerClientMain.class.getResource("/sound/" + id + ".mp3");
//			}
//			try {				
...
//		URL musicURL = ViewerClientMain.class.getResource("/midi/" + name + ".mid");
