...
public class DialogManager 
{
	...
	ArrayList<JDialog> m_alVisibleDialogs;
	public DialogManager(ViewerClientMain c) {
		m_client = c;
		m_alVisibleDialogs = new ArrayList<JDialog>();
	}
	...
	public void showMessageDialogNonBlocking(String message) {
		showMessageDialogNonBlocking(ViewerClientMain.APP_NAME, message);
	}
	...
	public void showMessageDialog(String message) {
		showMessageDialogBlocking(ViewerClientMain.APP_NAME, message);
	}
	...
	public String showInputDialog(
		...
		JDialog dialog = pane.createDialog(m_client, ViewerClientMain.APP_NAME);
