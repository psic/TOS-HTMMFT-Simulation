...
{		
	public Vector<FPlayer> fplayers = new Vector<FPlayer>(30);			
	...
	{
		super();
		fplayers = new Vector<FPlayer>(30);	
	}	 
	...
	public void add(FPlayer player, int id) {
		//System.out.println(fplayers.size() + " / ID : "+ id);
		fplayers.set(id, player);
		
	}
	
	public int getFormationArraySize(){
