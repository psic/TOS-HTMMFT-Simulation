...
public class RefereeData implements Data
{
 ...
 /**
  ...
  public int mode;
  /**
   * the ID of some player; in the off side mode this is the violator  
   * (could be used for different purposes in other modes)
   */
  public int playerID;
 /**
   * the side who should continue the game.
   */
  ...
  public RefereeData(int time, int period, int mode, int playerID, char sideToContinue,
