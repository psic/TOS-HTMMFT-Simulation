...
public abstract class AbstractClientAction extends AbstractAction {
	...
	private static final long serialVersionUID = -8215737467673356126L;
	...
	public AbstractClientAction(ViewerClientMain s) {
		m_s = s;
	}

	public void setSoccerMaster(ViewerClientMain s) {
		m_s = s;
	}
	...
	protected final ViewerClientMain getSoccerMaster() {
		return m_s;
	}
