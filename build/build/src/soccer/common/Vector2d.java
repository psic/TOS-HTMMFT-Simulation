...
public class Vector2d {
  ...
  public double direction(Vector2d that) {
    double dir = Math.toDegrees(Math.atan2(that.getY() - getY(), that.getX() - getX()));
    return dir;
  }
  ...
  public static double polar_dir(Vector2d vec) {
    double dir = Math.toDegrees(Math.atan2(vec.getY(), vec.getX()));
    return dir;
  } 
  ...
  public static double polar_dist(Vector2d vec) {
    double dist = Math.sqrt(Util.pow2(vec.getY()) + Util.pow2(vec.getX()));
    return dist;
  } 
